...
<div style="width: 1000px;">
    ...
    <div>Продавец: [% vars.glob_vars.seller_firm %]</div>
    <div>Адрес: [% vars.glob_vars.seller_legal_address %]</div>
    <div>ИНН/КПП продавца: [% vars.glob_vars.seller_inn %] / [% vars.glob_vars.seller_kpp %]</div>
    <div>Грузоотправитель и его адрес: [% vars.glob_vars.seller_firm %]</div>
